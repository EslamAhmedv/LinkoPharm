...
<?php
  ...
  <div class="responsive-container-block Container bottomContainer">
    <div class="ultimateImg">
      <img class="mainImg"  src="../public/images/aboutus.jpg.jpg" alt="" />
      <div class="purpleBox">
        <p class="purpleText">
        Linko-Pharm is a performance-oriented company where our employees are the company’s strongest talent. Their commitment, dedication and aspiration help create a fast moving
        </p>
    ...
    <div class="allText bottomText">
      ...
      Linko Pharmaceuticals is a limited liability cosmoceutical company that was established in 2002 
      </p>
      ...
      <a href="https:/wa.me/201066656123" class="explore">
        Contact with Us
      </a>
    </div>
  </div>

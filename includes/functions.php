...
function signup($data)
{
	...
	if(count($errors) == 0){
		...
		$query = "insert into users (firstname,lastname,username,email,gender,password,date) values 
		(:firstname,:lastname,:username,:email,:gender,:password,:date)";
...
{
	$string = "mysql:host=localhost;dbname=linkopharm";
